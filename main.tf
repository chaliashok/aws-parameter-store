...
variable "params" {
  default = [
    ...
    { name = "roboshop.dev.cart.redis_host", value = "elasticache-dev.pkvd9r.clustercfg.use1.cache.amazonaws.com", type = "String" },
    { name = "roboshop.dev.cart.catalogue_host", value = "catalogue-dev.devopsawschinni.online", type = "String" },
    ...
    { name = "roboshop.dev.user.redis_host", value = "elasticache-dev.pkvd9r.clustercfg.use1.cache.amazonaws.com", type = "String" },
    //    { name = "roboshop.dev.user.mongo_url", value = "mongodb://mongodb-dev.devopsawschinni.online:27017/users", type = "String" },
    ...
    { name = "roboshop.prod.cart.redis_host", value = "elasticache-prod.pkvd9r.clustercfg.use1.cache.amazonaws.com", type = "String" },
    ...
    { name = "roboshop.prod.user.redis_host", value = "elasticache-prod.pkvd9r.clustercfg.use1.cache.amazonaws.com", type = "String" },
